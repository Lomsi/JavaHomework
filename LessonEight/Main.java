...
public class Main extends Object { // Main is the class that runs the program
    public static void main(String[] args) { // main is the method that runs the program
        ...
        // Object[] objects = {moorcha, moonCake, poochky , 21 , "blablba"}; // create
        // an array of numbers
        System.out.println(
                poochky.makeSound() + " " + moonCake.makeSound() + " " + moorcha.makeSound() + " " + rufus.makeSound());
        // print the sound of the cat objects
    }
}